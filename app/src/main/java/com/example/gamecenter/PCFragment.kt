 ...
 * Use the [PCFragment.newInstance] factory method to
...
class PCFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val t = inflater.inflate(R.layout.fragment_p_c, container, false)
        ...
        var options = arrayOf("Valorant","League of Legends", "Teamfight Tactics")
